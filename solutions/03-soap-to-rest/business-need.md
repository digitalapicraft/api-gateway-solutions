...
| **Auth** | Implemented per adapter, differently each time | Once, at the edge ([solution 02](../02-oauth-jwt/)) |
...
[solution 01](../01-api-products/), and it isn't reachable from a SOAP endpoint with
a WSDL.
