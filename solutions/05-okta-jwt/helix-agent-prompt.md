...
fourteen, four of them overriding defaults you would not guess, and one absent from
the published schema. Asked for as a single outcome, the agent drops exactly the
hardening fields — they come last. So paste Step 1, then Step 2.
