# How it works — Solution 04 — Analytics: read what your gateway already captured

[Overview](readme.md) · [Business need](business-need.md) · **How it works** · [Install](install.md) · [Query catalogue](charts.md) · [Changelog](changelog.md)
