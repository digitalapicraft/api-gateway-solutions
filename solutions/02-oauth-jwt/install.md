...
> **The upstream is not in this document.** It is bound to the *service* at
> import/bind time, not expressed in the OpenAPI paths. Nothing in
> `gateway/api-spec.yaml` can confirm your upstream is reachable — a spec that
> imports and dry-runs cleanly still tells you nothing about the backend behind
> it. Check the binding on the service after import.
