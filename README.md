...
| **04** | [Analytics](solutions/04-analytics/) | *"We can't tell which of our 400 integrations caused the 3am pager."* Analytics is already capturing every call — this is how you ask it the right questions. | [prompt](solutions/04-analytics/helix-agent-prompt.md) |
